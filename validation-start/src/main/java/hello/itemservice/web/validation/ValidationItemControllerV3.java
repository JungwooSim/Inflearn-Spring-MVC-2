...
public class ValidationItemControllerV3 {
    ...
    /**
     * 모든 컨트롤러에서 itemValidator 적용할 수 있도록 준비
     * @Validated 어노테이션을 이용해서 itemValidator 모두 적용 가능
     * WebDataBinder 는 요청이 올때마다 새로 생성됨.
     * @param dataBinder
     */
    @InitBinder
    ...
    // 주의! BindResult 는 @ModelAttribute 바로 뒤에 나와야 함.
//    @PostMapping("/add")
